  ...
  if (error) {
    ...
    if (formFallback) {
      return (
        <div className="flex flex-col items-center mt-20">
          ...
          <Link href="/" className="text-blue-400 underline">Back to Pokédex</Link>
        </div>
      );
    }
    ...
    return (
      <div className="text-center mt-20 text-lg text-red-400">
        ...
        <div>
          <Link href="/" className="text-blue-400 underline ml-2">Back to Pokédex</Link>
        </div>
      </div>
    );
  }
...
function speciesVarId(name: string): string {
